...
public class WebFile {
	...
	//static Queue<Integer> Last12Queries = new CircularFifoQueue<Integer>(2);
	...
	public WebFile( String urlString )
		...
		// Send the request.
		//DONE implement the limit of "Up to 12 calls per second"
		try {Thread.sleep(83);} catch (Exception e) {}
		//TODO implement the limit of "Up to 5,000 calls per day"
		conn.connect( );
